...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["deaths-deaths-module"], {
  ...
  function srcAppPagesDeathsDeathsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DeathsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _deaths_routing_module__WEBPACK_IMPORTED_MODULE_5__["DeathsPageRoutingModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
    ...
    var DeathsPage = /*#__PURE__*/function () {
      ...
      _createClass(DeathsPage, [{
        ...
        value: function ngOnInit() {
          this.loadDeaths(); //initialize loadDeaths Method
        ...
        value: function loadDeaths() {
          ...
          this.deaths.subscribe(function (data) {
            _this.mDeaths = [data]; // console it is only to check the info in console 
            //console.log( data); 
          });
        ...
        value: function searchDeath(event) {
          ...
          this.searchdeath = text; //it will show the text in the console
          // console.log(text);
        }
      }]);
