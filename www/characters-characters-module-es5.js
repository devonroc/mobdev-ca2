    ...
    **/
    ...
    var CharactersPage = /*#__PURE__*/function () {
      function CharactersPage(router, api, http) {
        ...
        this.router = router;
        this.api = api;
        this.http = http; //the offset that the page will start

        this.offset = 0; //chars is the array where the elements will be stored

        this.chars = []; //the maximun number of elements that will be charged in the page
      ...
      _createClass(CharactersPage, [{
        ...
        value: function loadCharacters(event) {
          ...
          this.api.getCharacters(this.offset).subscribe(function (data) {
            ...
            _this.chars = _this.chars.concat(data);
        ...
        value: function loadMore(event) {
          ...
          console.log(event); //when the offset reaches the number of elements set in the 
        ...
        value: function openDetails(character) {
          ...
          this.characterId.subscribe(function (data) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])], CharactersPage);
    /***/
  }
}]);
