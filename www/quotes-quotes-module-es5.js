...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    QuotesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _quotes_routing_module__WEBPACK_IMPORTED_MODULE_5__["QuotesPageRoutingModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
    ...
    **/
    ...
    var QuotesPage = /*#__PURE__*/function () {
      function QuotesPage(router, api) {
        ...
        this.router = router;
        this.api = api; //in the array quoteItem the quotes will be stored in a new array

        this.quoteItem = []; //mySearch is the variable where the input from the user will be stored when a search is being done
      ...
      _createClass(QuotesPage, [{
        ...
        value: function ngOnInit() {
          this.loadQuotes(); //initialize loadDeaths Method
        ...
        value: function loadQuotes() {
          ...
          this.quotes.subscribe(function (data) {
            _this.quoteItem = [data]; //console.log( data); 
          });
        ...
        value: function searchQuote(event) {
          ...
          this.mySearch = text; //return(text.toLowerCase().indexOf(text.toLowerCase())>-1);
